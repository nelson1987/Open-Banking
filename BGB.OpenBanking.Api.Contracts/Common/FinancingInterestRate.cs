...
namespace BGB.OpenBanking.Api.Contracts.Common
{
    ...
    /// </summary>
    [DataContract]
    public partial class FinancingInterestRate : IEquatable<FinancingInterestRate>
    {
        /// <summary>
        /// Gets or Sets Fees
        /// </summary>
        ...
        /// </summary>
        /// <value>Percentual mínimo cobrado (taxa efetiva) no mês de referência, para o Financiamento contratado  A apuração pode acontecer com até 4 casas decimais. O preenchimento deve respeitar as 4 casas decimais, mesmo que venham preenchidas com zeros (representação de porcentagem p.ex: 0.1500. Este valor representa 15%. O valor 1 representa 100%)</value>
        [Required]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FinancingInterestRate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FinancingInterestRate)obj);
        }
...
#pragma warning disable 1591
        ...
        public static bool operator ==(FinancingInterestRate left, FinancingInterestRate right)
        {
