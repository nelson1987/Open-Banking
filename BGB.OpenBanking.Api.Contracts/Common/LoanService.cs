...
namespace BGB.OpenBanking.Api.Contracts.Common
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoanService : IEquatable<LoanService>
    {
        /// <summary>
        /// Nomes das Tarifas cobradas sobre Serviços relacionados à Modalidade informada do Empréstimo para pessoa natural/jurídica.
        /// </summary>
        /// <value>Nomes das Tarifas cobradas sobre Serviços relacionados à Modalidade informada do Empréstimo para pessoa natural/jurídica.</value>
        [Required]
        ...
        /// </summary>
        /// <value>Sigla de identificação do serviço relacionado à Modalidade informada de Empréstimo para pessoa natural/jurídica.</value>
        [Required]
        [DataMember(Name = "code")]
        public string Code { get; set; }

        /// <summary>
        /// Fatores geradores de cobrança que incidem sobre as Modalidades informada de Empréstimos para pessoa natural/jurídica.
        /// </summary>
        /// <value>Fatores geradores de cobrança que incidem sobre as Modalidades informada de Empréstimos para pessoa natural/jurídica.</value>
        [Required]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((LoanService)obj);
        }

        /// <summary>
        /// Returns true if LoanService instances are equal
        /// </summary>
        /// <param name="other">Instance of LoanService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoanService other)
        {
...
#pragma warning disable 1591
        ...
        public static bool operator ==(LoanService left, LoanService right)
        {
